...
using namespace std;
//---------------------------------------------------------------------------
static bool  sortDirectShiftDoc;
//---------------------------------------------------------------------------
class TFShiftDoc : public TForm
{
__published:	// IDE-managed Components
   ...
   TLabel *CashInSafe;
        ...
        void __fastcall StanShiftDblClick(TObject *Sender);
...
public:		// User declarations
        __fastcall TFShiftDoc(int shift_id, TComponent* Owner);
        //
        void SetTitleCaptionCheck( void );
        void SetTitleCaptionTovar( void );
};
//---------------------------------------------------------------------------
extern PACKAGE TFShiftDoc *FShiftDoc;
//---------------------------------------------------------------------------
#endif
